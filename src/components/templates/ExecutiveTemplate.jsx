  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
      ...
      <h2 style={{
        ...
        color: theme.primary, fontWeight: 700, margin: 0,
      }}>
        {children}
      </h2>
...
export function ExecutiveTemplate({ cv, theme }) {
  ...
  return (
    <div style={{
      ...
      color: '#1a1a2e', background: '#fff', minHeight: '297mm',
    }}>
      ...
      <header style={{ display: 'flex', borderBottom: `3px solid ${t.primary}` }}>
        ...
        <div style={{
          ...
          background: '#f9f9f7', padding: '32px 24px',
          ...
          {p.email   && <div style={{ display: 'flex', gap: '6px', fontSize: '11px' }}><span style={{ color: '#888' }}>✉</span><span style={{ color: '#555' }}>{p.email}</span></div>}
          {p.phone   && <div style={{ display: 'flex', gap: '6px', fontSize: '11px' }}><span style={{ color: '#888' }}>✆</span><span style={{ color: '#555' }}>{p.phone}</span></div>}
          {p.address && <div style={{ display: 'flex', gap: '6px', fontSize: '11px' }}><span style={{ color: '#888' }}>⊙</span><span style={{ color: '#555' }}>{p.address}</span></div>}
          {p.website && <div style={{ display: 'flex', gap: '6px', fontSize: '11px' }}><span style={{ color: '#888' }}>⊕</span><span style={{ color: '#555' }}>{p.website}</span></div>}
        </div>
      </header>
